...
//		});
	...
	public void exitForm( ActionEvent evt )
	{
		this.dispose();
	}
...
//				System.exit(0);
		...
		bNew = new SmallButton(actionNew, "Open RTF document");
		...
		Action action = new AbstractAction("Copy", new ImageIcon( "images/edit_copy.gif")) {
			public void actionPerformed(ActionEvent e) {
				m_monitor.copy();
			}
		};
...
//				m_monitor.cut();
		...
		m_toolBar.addSeparator();
// defect, 72變7200, 初始化錯誤, S.K.Wen
//		m_fontSizes = new String[] { "8", "9", "10", "11", "12", "14", "16",
//				"18", "20", "22", "24", "26", "28", "36", "48", "72" };
		m_fontSizes = new String[] { "8", "9", "10", "11", "12", "14", "16",
				"18", "20", "22", "24", "26", "28", "36", "48", "72000" };
...
class FontDialog extends JDialog {
	...
	public FontDialog(JFrame parent, String[] names, String[] sizes) {
		...
		m_chkBold = new JCheckBox("Italic");
		p.add(m_chkBold);
		...
		m_preview = new JLabel("Congratulations!! You find a defect.", JLabel.CENTER);
