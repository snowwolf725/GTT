...
public class ScriptTabularEditor extends TabularEditor {

	private KTable _table = null;
	private TableModel _model = null;

	public ScriptTabularEditor() {
		super();
	}
	...
	protected Object[] createHeader() {
		return HeaderAnalyzer.createDefaultHeader(TableConstants.DEFAULT_SCRIPT_HEADER, _model.getColumnCount());
	}
}
