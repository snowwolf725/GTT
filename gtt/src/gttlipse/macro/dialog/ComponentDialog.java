...
public class ComponentDialog extends TitleAreaDialog implements ModifyListener {
	private ComponentNode m_node;
	private ComponentInfoPanel m_componentInfoPanel;
	private EventCoverPanel m_eventCoverPanel;
	private Label m_coverage;
	private Text _nodeName;

	public ComponentDialog(Shell parentShell, ComponentNode node) {
		super(parentShell);
		m_node = node;
	}

	protected Control createDialogArea(Composite parent) {
		getShell().setText("Component Node");
		setMessage("Edit Component Node");
		...
		m_componentInfoPanel = new ComponentInfoPanel(selectComponent, m_node
				.getComponent());
