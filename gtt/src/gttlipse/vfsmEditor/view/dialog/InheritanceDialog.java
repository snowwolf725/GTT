...
public class InheritanceDialog extends TrayDialog {

	private Text	m_nameText			= null;
	private String	m_inheritanceName	= "";
	
	// constructor
	public InheritanceDialog(Shell  parentShell, String initName) {
		super( parentShell );
		m_inheritanceName = initName;
		this.create();
	}
	
	// constructor - initial a title string for dialog
	public InheritanceDialog(Shell  parentShell, String title, String initName) {
		super( parentShell );
		m_inheritanceName = initName;
		this.create();
	...
	protected Control createDialogArea( Composite parent ) 
    {
	    ...
	    group.setText( "Type a Inheritance Name" );
	 ...
	 // create label and textbox
		...
		m_nameText.setText( m_inheritanceName );
    ...
    private void modifyNodeName()
    {
    	...
    	{
    	    // refactor ?
    		m_inheritanceName = m_nameText.getText();
