...
public class LoadTestingResultViewLabelProvider implements ITableLabelProvider {
	private ImageRegistry m_imageRegistry = null;
	
	LoadTestingResultViewLabelProvider() {
		super();
		initImageRegistry();
	}
	...
	public Image getColumnImage(Object element, int columnIndex) {
		...
		if (element instanceof LoadTestingResultItem)
	...
	public String getColumnText(Object element, int columnIndex) {
		if (element == null)
			return "";
		if (element instanceof LoadTestingResultItem) {
			LoadTestingResultItem item = (LoadTestingResultItem)element;
			if(columnIndex == 0)
				return item.getType();
