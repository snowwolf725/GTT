...
public class RowFixture extends AbstractFitFixture {
	public RowFixture(FitTable table, MacroEventCallerNode node,
			MacroDocument doc) {
		m_fitTable = table;
	...
	private boolean configArgumentList(Arguments list, int tableOrder) {
		try {
			...
			System.err.println("RowFixture config argument Error!");
			return false;
		}
	}
