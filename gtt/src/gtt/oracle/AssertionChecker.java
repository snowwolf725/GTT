...
/**
 * doing assertion for GUI component 2007/01/04
 *
 * @author zws
 */
public interface AssertionChecker {

	public static final String[] TypeItems = { "char", "double", "float", "int",
			"String", "boolean", "long", "short" };

	public static final String[] BooleanItem = { "true", "false" };
