...
public class ContractListingVisitor implements IMacroStructureVisitor {

	public ContractListingVisitor() {
	}
	...
	public void visit(MacroEventNode node) {
		MacroContract contract = node.getContract();

		if(contract.getLevel()<2) return;
		
		System.out.println(node.getName());
		System.out.println("\t" + contract.getLevel());
		System.out.println("\tP:" + contract.getPreCondition());
		System.out.println("\tA:" + contract.getAction());
		System.out.println("\tQ:" + contract.getPostCondition());
