...
public class InvisibleRootNode extends CompositeMacroNode {

	public InvisibleRootNode() {
		super("");
	}

	public InvisibleRootNode clone() {
		return new InvisibleRootNode();
	}
	...
	public int getNodeID() {
		return EditDialogFactory.NID_INVISIBLEROOT_NODE;
	}
}
