...
public class SwingScriptDialogFactory implements IScriptDialogAbstractFactory {
	...
	public INodeDialog createModelAssertNodeDialog() {
		return new ModelAssertNodeDialog();
	}

	public INodeDialog createViewAssertNodeDialog() {
		return new ViewAssertNodeDialog();
	}
